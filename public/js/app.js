(function () {
  ...
  function debugDialogBox () {
    ...
    var $css = $('.debug__plugin--css');
    $('.debug-plugin__select');
    var $pluginValue = $('.debug-plugin__value');
    /**
    ...
    $('.debug__show-asset').on('click', function () {
      var pluginValue = $pluginValue.val().trim();
      $css.val().trim();
      /**
