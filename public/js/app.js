(function () {
  ...
  vnjs.on("spriteimg", function (args) {
    if (args) {
      console.log(vnjs.getAssetByName(args.source).url);
      $sprite.css({
  ...
  */
  ...
  function greyscale(data) {
    ...
    Object.assign(target.style, {
      'filter': "".concat(type, "(").concat(value, ")"),
      '-webkit-filter': "".concat(type, "(").concat(value, ")"),
      'transition': "".concat(duration, "s filter linear"),
      '-webkit-transition': "".concat(duration, "s  -webkit-filter linear")
    });
  }
  function filter () {
    vnjs.on('filter', function (param) {
    ...
    vnjs.on('image.update', function ($img) {
