(function () {
  ...
  function getImageSize (asset) {
    ...
    var _char = this.getCharacters()[0];

    if (asset) {
      var img = new Image();

      img.onload = function () {
        _vnjs.exec(_defineProperty({}, _char.id, "<font color=\"orange\">".concat(this.width, "</font> x <font color=\"orange\">").concat(this.height, "</font>")));
      };

      img.src = this.getAssetByName(asset).url;
    } else {
      _vnjs.exec(_defineProperty({}, _char.id, "<font color=\"brown\">\u0422\u0440\u0443\u0431\u0443\u0435\u0442\u0441\u044F \u0438\u043D\u0434\u0438\u0444\u0438\u043A\u0430\u0442\u043E\u0440 \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F</font>"));
    }
  }
  ...
  function debugDialogBox () {
    ...
    $('.debug__show-asset').on('click', function () {
      ...
      _vnjs.exec(_defineProperty({}, pluginName, pluginValue));
    });
    var flagDB = false;
