(function (factory) {
  ...
  var css$l = ".screen__cloud {\n  width: 500px;\n  background: wheat;\n  padding: 30px;\n  flex-wrap: wrap;\n  justify-content: center;\n  align-content: center;\n  align-items: center;\n  z-index: 1000;\n  box-shadow: 3px 3px 10px rgba(0, 0, 0, 0.3);\n  transform: translate(-50%, 0);\n  top: 10%; }\n  .screen__cloud .tag {\n    padding: 10px 15px;\n    font-size: 18px;\n    margin: 10px;\n    display: inline-flex;\n    background: #444;\n    cursor: pointer;\n    color: #34d1a2;\n    transition: 0.3s;\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.7); }\n    .screen__cloud .tag:hover {\n      background: #000;\n      color: darkcyan; }\n";
  n(css$l,{});

  var tpl$9 = "<div class=\"screen__cloud component center\"></div>";
  ...
  var tpl$8 = "<div class=\"stream__show-frame component\">\n                    <div class=\"stream__show-frame__cell\"></div>\n                    <div class=\"stream__show-frame__cell\"></div>\n                    <div class=\"stream__show-frame__cell\"></div>\n                    <div class=\"stream__show-frame__cell\"></div>\n             </div>";
  function frame () {
    var _this = this;
  ...
  var tpl$6 = "<div class=\"main-menu component\"></div>";
  ...
  var tpl$4 = "<div class=\"stream__qa component center\"></div>";
  ...
  var css$9 = ".stream__wiki {\n  left: 10px;\n  top: 40px;\n  width: 300px;\n  display: none;\n  height: auto;\n  padding: 10px;\n  border-radius: 4px;\n  background-color: rgba(0,0,0,0.5);\n  z-index: 7100;\n  font-size: 14px;\n}\n.stream__wiki li{\n  padding: 5px 0;\n\n  line-height: 18px;\n    \n}\n.stream__wiki-key{\n  color: wheat;\n}\n.stream__wiki-dash{\n  padding: 0 5px;\n  color: silver;\n}\n.stream__wiki-value{\n  color: darkgray;\n}";
  n(css$9,{});

  var $tpl$5 = $('<ul class="stream__wiki component"></ul>');
  function wiki () {
    var _this = this;
  ...
  var css$6 = ".screen-stream__slide{\n  position: absolute;\n  display: none;\n  top: 5%;\n  left: 50%;\n  transform: translateX(-50%);\n  box-shadow: 3px 3px 12px rgba(0, 0, 0, 0.5);\n  z-index: 2000;\n}";
  n(css$6,{});

  var $tpl$3 = $("<img class=\"screen-stream__slide component\"/>");
  function slide () {
    var _this = this;
    ...
    this.on('slide', function (id) {
      ...
      if (typeof id === 'string') {
        $tpl$3.attr('src', _this.getAssetByName(id).url).show();
        ...
        if (id.hasOwnProperty('url')) {
          ...
          $tpl$3.attr('src', _this.getAssetByName(id.name).url).show();
        }
        /*
        .css(id.css)
         */
  ...
  var $tpl$2 = $("<ul class=\"stream__stage component\"></ul>");
  function content () {
    var _this = this;
  ...
  function showTerminal() {
    $tpl.empty();
    var $iframe = $('<iframe src="data/brython/index.html" width="758" height="430"></iframe>');
    $tpl.append($iframe);
    $tpl.show();
  }
  ...
  var tpl = "<div class=\"vnjson__video component\">\r\n    <div id=\"vnjson__video\"></div>\r\n</div>\r\n";
  ...
  function video () {
    ...
    var player = videojs('vnjson__video', options, function onPlayerReady() {
      ...
      player.play(); // How about an event listener?
    ...
    */
    ...
    this.on('video', function (data) {
      if (data) {
        var asset = _this.getAssetByName(data);

        console.log(asset); //player.src('scenes/assets/abc.webm')
