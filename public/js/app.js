(function () {
  ...
  function debugDialogBox () {
    $tpl$b.css('background-image', "url(".concat(dialogBoxImage$1, ")"));
  ...
  function print(character, reply) {
    var replyWrapper = $tpl$b.find('.debug__dialog-box__reply-wrapper');
    var checkedHands = $('#debug__hands').prop('checked');

    if (character.avatar && checkedHands) {
      replyWrapper.css('width', '75%');
      $tpl$b.find('.debug__dialog-box__avatar').show().css({
        backgroundImage: "url('".concat($vnjs.getAssetByName(character.avatar).url, "')")
      });
      $tpl$b.find('.debug__dialog-box__name').html(character.name).css({
        color: character.nameColor
      });
      $tpl$b.find('.debug__dialog-box__reply').html(reply).css({
    ...
    if (!character.avatar && !checkedHands) {
      ...
      $tpl$b.find('.debug__dialog-box__avatar').hide();
      $tpl$b.find('.debug__dialog-box__name').html(character.name).css({
        color: character.nameColor
      });
      $tpl$b.find('.debug__dialog-box__reply').html(reply).css({
  ...
  function setCharacterToReply(reply, replyColor) {
    ...
    if (characterAliaces) {
      ...
      $tpl$b.find('.debug__dialog-box__reply').html(newReply).css({
        color: replyColor
      });
    }
  }
  ...
  function hands () {
    ...
    this.on('hand-left', function (id) {
      if (id) {
        isShow = true;
        $tpl$9.show();
        $tpl$9.find('.stream__hand-left').css('background-image', "url('".concat(_this.getAssetByName(id).url, "')"));
      } else {
        $tpl$9.find('.stream__hand-left').css('background-image', "unset");
      }
    });
    this.on('hand-right', function (id) {
      if (id) {
        isShow = true;
        $tpl$9.show();
        $tpl$9.find('.stream__hand-right').css('background-image', "url('".concat(_this.getAssetByName(id).url, "')"));
      } else {
        $tpl$9.find('.stream__hand-right').css('background-image', "unset");
      }
    });
  ...
  $tpl$7.on("click", ".main-menu__item", clickHundler);
  ...
  var css$b = ".stream__wiki {\n  left: 10px;\n  top: 40px;\n  width: 300px;\n  display: none;\n  height: auto;\n  padding: 10px;\n  border-radius: 4px;\n  background-color: rgba(0,0,0,0.5);\n  z-index: 7100;\n  font-size: 14px;\n}\n.stream__wiki li{\n  padding: 5px 0;\n\n  line-height: 18px;\n    \n}\n.stream__wiki-key{\n  color: wheat;\n}\n.stream__wiki-dash{\n  padding: 0 5px;\n  color: silver;\n}\n.stream__wiki-value{\n  color: darkgray;\n}";
  n(css$b,{});

  var $tpl$6 = $('<ul class="stream__wiki component"></ul>');
  function wiki () {
    var _this = this;
  ...
  var click = true;
  $tpl$5.find('.stream__test-variants').on('click', '.stream__variants-item', function () {
  ...
  $tpl$5.find('.stream__test-next-btn').on('click', function () {
    $vnjs.exec({
      next: true,
      test: false
    });
  ...
  var css$8 = ".screen-stream__slide{\n  position: absolute;\n  display: none;\n  top: 5%;\n  left: 50%;\n  transform: translateX(-50%);\n  box-shadow: 3px 3px 12px rgba(0, 0, 0, 0.5);\n  z-index: 2000;\n}";
  n(css$8,{});

  var $tpl$4 = $("<img class=\"screen-stream__slide component\"/>");
  function slide () {
    var _this = this;
    ...
    this.on('slide', function (id) {
      ...
      if (typeof id === 'string') {
        $tpl$4.attr('src', _this.getAssetByName(id).url).show();
        ...
        if (id.hasOwnProperty('css')) {
          $tpl$4.css(id.css);
          $tpl$4.attr('src', id.name).show();
        }

        if (id.hasOwnProperty('url')) {
          $tpl$4.attr('src', id.url).fadeIn();
        } else {
          $tpl$4.attr('src', _this.getAssetByName(id.name).url).show();
        }
        /*
        .css(id.css)
         */
  ...
  var $tpl$3 = $("<ul class=\"stream__stage component\"></ul>");
  function content () {
    var _this = this;
  ...
  function renderTree(data) {
    ...
    function clickHandler() {
      ...
      $tpl$3.off('click', clickHandler);
    }

    $tpl$3.on('click', '.stage-item', clickHandler);
  }
  ...
  var css$4 = ".stream__craftos{\n  width: 808px;\n  height: 480px;\n  padding: 25px;\n  overflow: hidden;\n  background-image: url(data:image/png;base64,);\n  background-size: contain;\n  background-repeat: no-repeat;\n  background-position: center;\n  position: absolute;\n  top: 5%;\n  left: 50%;\n  transform: translateX(-50%);\n  font-size: 18px;\n  line-height: 24px;\n  font-family: Minecraft; \n}\n\n\n";
  n(css$4,{});

  var $tpl$2 = $('<div class="stream__craftos component"></div>');
  var open = false;
  function craftos () {
  ...
  function plugins () {
    ...
    this.use(paintBoard);
    this.use(clipBoard);
    this.use(craftos); // this.use(brython);
