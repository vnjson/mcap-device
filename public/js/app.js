(function () {
  ...
  function debugDialogBox () {
    $tpl$d.css('background-image', "url(".concat(dialogBoxImage$1, ")"));
  ...
  function print(character, reply) {
    var replyWrapper = $tpl$d.find('.debug__dialog-box__reply-wrapper');
    var checkedHands = $('#debug__hands').prop('checked');

    if (character.avatar && checkedHands) {
      replyWrapper.css('width', '75%');
      $tpl$d.find('.debug__dialog-box__avatar').show().css({
        backgroundImage: "url('".concat($vnjs.getAssetByName(character.avatar).url, "')")
      });
      $tpl$d.find('.debug__dialog-box__name').html(character.name).css({
        color: character.nameColor
      });
      $tpl$d.find('.debug__dialog-box__reply').html(reply).css({
    ...
    if (!character.avatar && !checkedHands) {
      ...
      $tpl$d.find('.debug__dialog-box__avatar').hide();
      $tpl$d.find('.debug__dialog-box__name').html(character.name).css({
        color: character.nameColor
      });
      $tpl$d.find('.debug__dialog-box__reply').html(reply).css({
  ...
  function setCharacterToReply(reply, replyColor) {
    ...
    if (characterAliaces) {
      ...
      $tpl$d.find('.debug__dialog-box__reply').html(newReply).css({
        color: replyColor
      });
    }
  }
  ...
  function hands () {
    ...
    this.on('hand-left', function (id) {
      if (id) {
        isShow = true;
        $tpl$b.show();
        $tpl$b.find('.stream__hand-left').css('background-image', "url('".concat(_this.getAssetByName(id).url, "')"));
      } else {
        $tpl$b.find('.stream__hand-left').css('background-image', "unset");
      }
    });
    this.on('hand-right', function (id) {
      if (id) {
        isShow = true;
        $tpl$b.show();
        $tpl$b.find('.stream__hand-right').css('background-image', "url('".concat(_this.getAssetByName(id).url, "')"));
      } else {
        $tpl$b.find('.stream__hand-right').css('background-image', "unset");
      }
    });
  ...
  var css$p = ".screen__cloud {\n  width: 500px;\n  background: wheat;\n  padding: 30px;\n  flex-wrap: wrap;\n  justify-content: center;\n  align-content: center;\n  align-items: center;\n  z-index: 1000;\n  box-shadow: 3px 3px 10px rgba(0, 0, 0, 0.3);\n  transform: translate(-50%, 0);\n  top: 10%; }\n  .screen__cloud .tag {\n    padding: 10px 15px;\n    font-size: 18px;\n    margin: 10px;\n    display: inline-flex;\n    background: #444;\n    cursor: pointer;\n    color: #34d1a2;\n    transition: 0.3s;\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.7); }\n    .screen__cloud .tag:hover {\n      background: #000;\n      color: darkcyan; }\n";
  n(css$p,{});

  var tpl$b = "<div class=\"screen__cloud component center\"></div>";
  ...
  var tpl$a = "<div class=\"stream__show-frame component\">\n                    <div class=\"stream__show-frame__cell\"></div>\n                    <div class=\"stream__show-frame__cell\"></div>\n                    <div class=\"stream__show-frame__cell\"></div>\n                    <div class=\"stream__show-frame__cell\"></div>\n             </div>";
  function frame () {
    var _this = this;
  ...
  var tpl$8 = "<div class=\"main-menu component\"></div>";
  ...
  var tpl$6 = "<div class=\"stream__qa component center\"></div>";
  ...
  var css$d = ".stream__wiki {\n  left: 10px;\n  top: 40px;\n  width: 300px;\n  display: none;\n  height: auto;\n  padding: 10px;\n  border-radius: 4px;\n  background-color: rgba(0,0,0,0.5);\n  z-index: 7100;\n  font-size: 14px;\n}\n.stream__wiki li{\n  padding: 5px 0;\n\n  line-height: 18px;\n    \n}\n.stream__wiki-key{\n  color: wheat;\n}\n.stream__wiki-dash{\n  padding: 0 5px;\n  color: silver;\n}\n.stream__wiki-value{\n  color: darkgray;\n}";
  n(css$d,{});

  var $tpl$8 = $('<ul class="stream__wiki component"></ul>');
  function wiki () {
    var _this = this;
  ...
  var click = true;
  $tpl$7.find('.stream__test-variants').on('click', '.stream__variants-item', function () {
  ...
  $tpl$7.find('.stream__test-next-btn').on('click', function () {
    $vnjs.exec({
      next: true,
      test: false
    });
  ...
  var css$a = ".screen-stream__slide{\n  position: absolute;\n  display: none;\n  top: 5%;\n  left: 50%;\n  transform: translateX(-50%);\n  box-shadow: 3px 3px 12px rgba(0, 0, 0, 0.5);\n  z-index: 2000;\n}";
  n(css$a,{});

  var $tpl$6 = $("<img class=\"screen-stream__slide component\"/>");
  function slide () {
    var _this = this;
  ...
  var $tpl$5 = $("<ul class=\"stream__stage component\"></ul>");
  function content () {
    var _this = this;
  ...
  function renderTree(data) {
    ...
    function clickHandler() {
      ...
      $tpl$5.off('click', clickHandler);
    }

    $tpl$5.on('click', '.stage-item', clickHandler);
  }
  ...
  var css$6 = ".stream__craftos{\n  width: 808px;\n  height: 480px;\n  padding: 25px;\n  overflow: hidden;\n  background-image: url(data:image/png;base64,);\n  background-size: contain;\n  background-repeat: no-repeat;\n  background-position: center;\n  position: absolute;\n  top: 5%;\n  left: 50%;\n  transform: translateX(-50%);\n  font-size: 18px;\n  line-height: 24px;\n  font-family: Minecraft; \n}\n\n\n";
  n(css$6,{});

  var $tpl$4 = $('<div class="stream__craftos component"></div>');
  var open = false;
  function craftos () {
  ...
  var tpl$2 = "<div class=\"vnjson__video component\">\r\n    <video id=\"vnjson__video\" class=\"video-js\"></video>\r\n</div>\r\n";
  ...
  var $tpl$1 = $('<div class="vnjson__area component"></div>');
  function area () {
    var _this = this;

    this.$store.$screen.append($tpl$1);
    this.on('area', handler$1.bind(this));
    $tpl$1.on('click', function (e) {
  ...
  function selectWord () {
    ...
    this.$store.$screen.append($tpl);
    var $dropZone = $tpl.find('.select-word__dropzone');
    var indexItem = 0;
    ...
    $tpl.find('.select-word__variants').on('click', '.select-word__item', function (e) {
  ...
  function handler(scriptData) {
    if (scriptData) {
      ...
      $tpl.find('.select-word__variants').empty(); //$tpl.find('.select-word__variants').removeClass('select-word__variants--disable')
