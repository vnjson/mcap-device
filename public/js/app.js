(function () {
  ...
  function getImageSize (asset) {
    ...
    if (asset) {
      ...
      img.onload = function () {
        var str = "".concat(asset, "<br>width: ").concat(this.width, "px<br>height: ").concat(this.height, "px");
  ...
  function debugDialogBox () {
    ...
    var devPlugins = ['img-size', 'cmd-player', 'cmd-server'];
    /**
    ...
    Object.keys(pluginsSnipet).forEach(function (pluginItem, index) {
      ...
      if (isDev) {
        tpl = "<div class=\"debug-plugin__name debug-plugin__name--dev\" data-plugin=\"".concat(pluginItem, "\">\n                            ").concat(pluginItem, "\n                      </div>");
      } else {
        tpl = "<div class=\"debug-plugin__name ".concat(index === 0 ? 'debug-plugin__name--active' : '', "\" data-plugin=\"").concat(pluginItem, "\">\n                            ").concat(pluginItem, "\n                      </div>");
      }
